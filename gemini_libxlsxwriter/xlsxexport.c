...
CROSS-COMPILATION ON LINUX (static build):
...
** Returns 0 on success, non-zero on error using sqlite3_mprintf for err_msg.
*/
...
static void xlsx_export_func(
    ...
    /* Return the count of exported tables on success */
