...
| opus_noexpat  | xlsximport | Claude Opus 4.5 | zipfile | Yes |
...
Parsing XML is complicated so all xlsximport variants (except opus_noexpat) rely on a reputable library: [Expat](http://expat.sourceforge.net/).
